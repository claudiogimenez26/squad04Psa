...
public class RecursoService {
    ...
    public CostoRecursoDTO obtenerCostoPorRecurso(
        ...
        List<Double> horasCargadas = cargasDeHoras
            .stream()
            .map(carga -> carga.getCantidadHoras())
            .toList();

        Double costoRecurso = horasCargadas
            .stream()
            .mapToDouble(hora -> rolRecurso.getCosto() * hora)
            .sum();
                    ...
                    cargasDelRecurso
                        ...
                        .filter(carga -> {
                            ...
                            boolean cumpleFiltro =
                                ((fechaInicio == null ||
                                        !fechaCarga.isBefore(fechaInicio)) &&
                                    (fechaFin == null ||
